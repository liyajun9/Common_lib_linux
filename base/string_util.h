...
#ifndef PUBLIC_BASE_STRING_UTIL_H_
#define PUBLIC_BASE_STRING_UTIL_H_
...
inline int VswPrintf(wchar_t* buffer, size_t size,
  ...
  BCHECK(IsWprintfFormatPortable(format));
...
//
// NOTE: DoubleToString is not thread-safe
...
#endif  // PUBLIC_BASE_STRING_UTIL_H_
