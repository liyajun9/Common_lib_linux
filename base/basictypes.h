...
#ifndef PUBLIC_BASE_BASICTYPES_H_
#define PUBLIC_BASE_BASICTYPES_H_
...
#define CHECK_EXIT_(condition)                                    \
  if (!(condition)) {                                             \
    std::cerr << "ERROR: [" << __FUNCTION__ << "() "<< __FILE__   \
              << ":" << __LINE__ << "] Check failed: " #condition \
                 ", exit!" << std::endl;                          \
    exit(-1);                                                     \
  }

#define BCHECK(condition)   CHECK_EXIT_(condition)

#endif  // PUBLIC_BASE_BASICTYPES_H_
